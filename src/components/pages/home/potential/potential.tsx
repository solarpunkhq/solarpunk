...
function Potential() {
  ...
  const sliderTextContent = [
    {
      title: t('potential_sliderItem1Title'),
      description: t('potential_sliderItem1Description'),
      buttonText: t('potential_sliderButtonText'),
      buttonLink: '/' as Route<string>,
    },
    {
      title: t('potential_sliderItem2Title'),
      description: t('potential_sliderItem2Description'),
      buttonText: t('potential_sliderButtonText'),
      buttonLink: '/' as Route<string>,
    },
    {
      title: t('potential_sliderItem3Title'),
      description: t('potential_sliderItem3Description'),
      buttonText: t('potential_sliderButtonText'),
      buttonLink: '/' as Route<string>,
    },
    {
      title: t('potential_sliderItem4Title'),
      description: t('potential_sliderItem4Description'),
      buttonText: t('potential_sliderButtonText'),
      buttonLink: '/' as Route<string>,
    },
  ];
