...
function Farm() {
  return (
    <section className="farm mb-[220px] mt-[219px] px-safe lg:mb-[157px] lg:mt-[162px] md:mb-[136px] md:mt-[133px] sm:mb-[104px] sm:mt-[103px]">
        ...
        <div className="flex max-w-xl flex-col">
          ...
          <ul className="relative mb-0.5 mt-auto md:mt-11 sm:mt-[38px]">
            {items.map(({ text, icon }, i) => {
              return (
                <li
                  className="flex items-center gap-x-7 border-t py-8 last:border-b lg:gap-x-[23px] lg:py-7 md:py-5"
                  key={i}
                >
                  <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-[5px] bg-[#323232] md:h-12 md:w-12 sm:h-11 sm:w-11">
                    <img className="w-[42px] md:w-9" src={icon} alt="" />
                  </div>
