...
function DashboardSidebar({ user_id, acres }: { user_id: number; acres: any[] }) {
  ...
  const [deploymentType, setDeploymentType] = useState('open_space_photovoltaics');
  ...
  return (
    <div className="relative mb-4 mt-10 h-[80vh] flex-col overflow-x-auto rounded-xl border-2 border-gray-80 bg-gray-98 p-4 text-14">
      <h1 className="mb-4 font-title text-28 font-bold">Your Acres</h1>
      <div className="mb-4">
        Please submit additional information about your land. This information will help us process
        ...
        >
          <span className="flex w-full flex-1">
            <span className="flex w-full flex-col ">
              ...
              />
              <span className="text-sm text-gray-18 block font-medium">
                Open Space Photovoltaics
              </span>
              <span className="text-sm mt-1 flex items-center text-gray-30">
                Traditional solar deployment on acres that will not be used for agriculture
              </span>
              <span className="text-sm text-gray-18 mt-6 font-medium">
          ...
          <span className="flex w-full flex-1">
            <span className="flex w-full flex-col">
              <img
                ...
                className="mb-2 w-full"
              />
              <span className="text-sm text-gray-18 block font-medium">Agrivoltaics</span>
              <span className="text-sm mt-1 flex items-center text-gray-30">
        ...
        >
          <span className="flex flex-1">
            <span className="flex flex-col">
              <span className="text-sm text-gray-18 block font-medium">Help me decide</span>
              <span className="text-sm mt-1 flex items-center text-gray-30">
      ...
      >
        ...
        >
          <span className="flex flex-1">
            <span className="flex flex-col">
              <span className="text-sm block font-semibold text-gray-8">Financing myself</span>
              <span className="text-sm mt-1 flex items-center text-gray-30">
        ...
        >
          <span className="flex flex-1">
            <span className="flex flex-col">
              <span className="text-sm block font-semibold text-gray-8">Financed by loan</span>
              <span className="text-sm mt-1 flex items-center text-gray-30">
        ...
        >
          <span className="flex flex-1">
            <span className="flex flex-col">
              <span className="text-sm block font-semibold text-gray-8">Financed by Solarpunk</span>
              <span className="text-sm mt-1 flex items-center text-gray-30">
      ...
      <div className="text-gray-500 my-2 flex">
        <span>
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <Button className="mt-4 rounded-md px-6 py-2" theme="black" onClick={submitForm}>
          {loading && (
