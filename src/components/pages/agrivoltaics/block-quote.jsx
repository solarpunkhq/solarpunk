...
import { Border } from '@/components/pages/agrivoltaics/border';
...
function BlockquoteWithImage({ author, image, children, className }) {
  return (
    ...
    >
      <blockquote className="text-neutral-600 col-span-2 text-xl/7 sm:col-span-7 sm:col-start-6 sm:row-start-2">
        {typeof children === 'string' ? <p>{children}</p> : children}
      </blockquote>
      <div className="bg-neutral-100 col-start-1 row-start-2 overflow-hidden rounded-xl sm:col-span-5 sm:row-span-full sm:rounded-3xl">
        <Image
          alt=""
          {...image}
      ...
      <figcaption className="text-neutral-950 text-sm sm:col-span-7 sm:row-start-3 sm:text-base">
  ...
  return (
    <Border position="left" className={clsx('pl-8', className)}>
      <figure className="text-sm">
        ...
        <figcaption className="text-neutral-950 mt-6 font-semibold">
