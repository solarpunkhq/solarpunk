...
export default function Terms() {
  return (
    <Container>
      ...
      <p>
        By accessing or using Solarpunkhq.com, you agree to comply with and be legally bound by the
        terms outlined in this agreement. If you do not agree to these terms, you must refrain from
        using our services.
      </p>
      ...
      <p>
        ...
        installers. We collect certain personal information from farmers, including but not limited
        to:
      </p>
      <ul>
        <li>Full Name</li>
      ...
      <p>
        ...
        and other personal information, will be used to connect you with photovoltaic installers in
        your region.
      </p>

      <h2>5. Data Security</h2>
      <p>
        Solarpunkhq.com takes reasonable measures to protect your personal information. However, no
        method of data transmission or storage is completely secure, and we cannot guarantee the
        absolute security of your information. You agree to use the Platform at your own risk.
      </p>
      ...
      <p>
        ...
        license to use, reproduce, and distribute the content for the purpose of providing services.
      </p>

      <h2>7. Disclaimer of Warranties</h2>
      <p>
        The Platform is provided on an "as-is" basis without any warranties of any kind, whether
        express or implied. Solarpunkhq.com makes no guarantees regarding the accuracy, reliability,
        or completeness of the services provided through the Platform.
      </p>

      <h2>8. Limitation of Liability</h2>
      <p>
        To the fullest extent permitted by law, Solarpunkhq.com shall not be liable for any direct,
        indirect, incidental, or consequential damages arising out of your use of the Platform or
        any services provided by photovoltaic installers.
      </p>
      ...
      <p>
        ...
        Jurisdiction], without regard to its conflict of law principles. Any legal action or dispute
        arising under these Terms shall be resolved in the courts of [Your Jurisdiction].
      </p>
