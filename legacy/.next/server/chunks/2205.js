...
module.exports = createProxy("/Users/peer/dev/solarpunk/node_modules/next/dist/client/image-component.js");
 //# sourceMappingURL=image-component.js.map
...
function X(T = fr) {
  (function(p, g, m) {
    ...
    p.Cal = p.Cal || function() {
      let c = p.Cal, v = arguments;
      if (c.loaded || (c.ns = {}, c.q = c.q || [], C.head.appendChild(C.createElement("script")).src = g, c.loaded = !0), v[0] === m) {
        const s = function() {
          h(s, arguments);
        }, y = v[1];
        s.q = s.q || [], typeof y == "string" ? (
...
function dr() {
  if (Te)
    return A;
  Te = 1;
  var T = react__WEBPACK_IMPORTED_MODULE_0__, p = Symbol.for("react.element"), g = Symbol.for("react.fragment"), m = Object.prototype.hasOwnProperty, h = T.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, C = { key: !0, ref: !0, __self: !0, __source: !0 };
  function c(v, s, y) {
    var l, R = {}, w = null, $ = null;
    y !== void 0 && (w = "" + y), s.key !== void 0 && (w = "" + s.key), s.ref !== void 0 && ($ = s.ref);
    for (l in s)
      m.call(s, l) && !C.hasOwnProperty(l) && (R[l] = s[l]);
    if (v && v.defaultProps)
      for (l in s = v.defaultProps, s)
        R[l] === void 0 && (R[l] = s[l]);
    return { $$typeof: p, type: v, key: w, ref: $, props: R, _owner: h.current };
  }
  return A.Fragment = g, A.jsx = c, A.jsxs = c, A;
}
var I = {};
/**
 * @license React
...
const gr = pr.jsx, mr = function(p) {
  ...
  const y = Ce(!1), l = cr(v), R = Ce(null);
  return Se(() => {
    if (!l || y.current || !R.current)
      return;
    y.current = !0;
    const w = R.current;
    h ? (l("init", h, {
  ...
  }, [l, g, C, h, m, c]), l ? /* @__PURE__ */ gr("div", {
    ref: R,
    ...s
  }) : null;
}, Er = (/* unused pure expression or super */ null && (mr)), hr = (T) => new Promise(function p(g) {
  X(T);
  const m = window.Cal;
  if (!m) {
    setTimeout(() => {
